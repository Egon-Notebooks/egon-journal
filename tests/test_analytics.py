...
from egon.analytics.word_count import count_words, plot_word_count, word_counts_by_day
...
class TestLoadJournalEntries:
    ...
    def test_falls_back_to_filename_date(self, tmp_path):
        # File with no frontmatter, date encoded in filename
